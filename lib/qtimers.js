...
module.exports.currentTime = function() { return getTimestamp() };
...
timeoutTimer.start(1, 1);
function startTimeoutTimer() { timeoutTimer._running = 1; timeoutTimer.ref(); }
function stopTimeoutTimer() { timeoutTimer.unref(); timeoutTimer._running = 0; }
// the timeout timer is always running and every ms it checks the timeout queues
...
function _processTimeoutTasks( ) {
    // update the currentTime() every millisecond
